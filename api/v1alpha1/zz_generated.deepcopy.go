...
func (in *ClusterPodPresetList) DeepCopyInto(out *ClusterPodPresetList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]ClusterPodPreset, len(*in))
		for i := range *in {
...
func (in *ClusterPodPresetSpec) DeepCopy() *ClusterPodPresetSpec {
	...
	out := new(ClusterPodPresetSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterPodPresetStatus) DeepCopyInto(out *ClusterPodPresetStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterPodPresetStatus.
func (in *ClusterPodPresetStatus) DeepCopy() *ClusterPodPresetStatus {
	if in == nil {
		return nil
	}
	out := new(ClusterPodPresetStatus)
	in.DeepCopyInto(out)
	return out
}
